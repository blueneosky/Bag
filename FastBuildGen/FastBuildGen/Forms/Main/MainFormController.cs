...
namespace FastBuildGen.Forms.Main
{
    internal class MainFormController
    {
        ...
        private readonly FBController _fastBuildController;
        ...
        public MainFormController(MainFormModel model)
        {
            ...
            _fbModel = _model.FBModel;
            _fastBuildController = new FBController(_fbModel);
        }
...
#warning TODO - re-use it for save
        ...
        internal void Deploy()
        {
            ...
            try
            {
                ...
                FastBuildBatchFile file = new FastBuildBatchFile(_fbModel);
...
#warning TODO - check if modele get new file name or not ...
        ...
        {
            bool success = new FastBuildImportMergeController(_fbModel).ImportWithMerge(configFilePath);
