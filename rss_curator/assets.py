...
class Assets:
    ...
    def get_assets_response(cls, filename: str) -> Response:
        match filename:
            ...
            case 'rss-icon.svg':
                return Response(content=cls.__RSS_ICON_SVG_CONTENT, media_type=cls.__RSS_ICON_SVG_CONTENT_TYPE, headers={'Cache-Control': 'max-age=3600'})
            case 'settings-icon.svg':
                return Response(content=cls.__SETTINGS_ICON_SVG_CONTENT, media_type=cls.__SETTINGS_ICON_SVG_CONTENT_TYPE, headers={'Cache-Control': 'max-age=3600'})
            case 'goback-icon.svg':
                return Response(content=cls.__GOBACK_ICON_SVG_CONTENT, media_type=cls.__GOBACK_ICON_SVG_CONTENT_TYPE, headers={'Cache-Control': 'max-age=3600'})
            case _:
    ...
    __RSS_ICON_SVG_CONTENT_TYPE = "image/svg+xml"
    __RSS_ICON_SVG_CONTENT = """<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <path   class="symbol" d="m 1,2 a 5,5 0 0 1 5,5 h 1 a 6,6 0 0 0 -6,-6 z" />
    ...
    __SETTINGS_ICON_SVG_CONTENT_TYPE = "image/svg+xml"
    __SETTINGS_ICON_SVG_CONTENT = """<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
...
"""
    ...
    __GOBACK_ICON_SVG_CONTENT_TYPE = "image/svg+xml"
    __GOBACK_ICON_SVG_CONTENT = """<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
